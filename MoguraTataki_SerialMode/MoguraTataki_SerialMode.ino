...
void GameStartManager(){
  ...
  if (digitalRead(2) == 1) {
    ...
    Serial.print(/*"ゲームスタート！"*/"GameStart!!");
    delay(1000);
...
void GameEndManager(){
  ...
  while(isBoot == false){
    ...
    Serial.println(/*"ゲームオーバー！"*/"GameOver");
   
    Serial.print(/*"合計ポイント："*/"Total : ");
    Serial.println(point);

    delay(4000);
   
    Serial.println("PleasePushReset");
   
    Serial.print(/*"合計ポイント："*/"Total : ");Serial.println(point);
    //////////////////////////////
    oneOver = false;
    }
    //終了後処理(LEDチカチカ)////////
...
///////時間計測///////////////////////////////
   ...
   totalTime -= deltaTime;
    ...
    if((int)second != (int)oldSecond) {Serial.print(minute); Serial.print(" : "); Serial.println((int)(second/1000));}
   
      Serial.print("Total : "); Serial.println(point);
...
// onTime = 3000;
   ...
   //pinの初期化////////////////
    ...
    Serial.println("3E-whack-a-mole");
    Serial.println("PleasePushButton");
